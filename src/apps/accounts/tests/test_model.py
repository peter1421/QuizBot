...
def test_create_superuser_with_invalid_username():
    ...
    User = get_user_model()
    with pytest.raises(ValueError):
        User.objects.create_superuser(phone='1234567890', username='', password='password123')
...
def test_password_encryption():
    ...
    """
    User = get_user_model()
    user = User.objects.create_user(phone='1234567890', username='testuser', password='password123')
